...
{
    public class clsSQLServerConnection
    {
        ...
        {
            get { return clsConfig.DBServerName; }
            set { dBServerName = value; }
        }

        public static string DbCatalogName
        {
            get { return clsConfig.DbCatalogName; }
            set { dbCatalogName = value; }
        }
        public static string DBUserName
        {
            get { return clsConfig.DBUserName; }
            set { dBUserName = value; }
        }

        public static string DBPassword
        {
            get { return clsConfig.DBPassword; }
